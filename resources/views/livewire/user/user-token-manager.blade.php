...
<div class="dark:bg-gray-900">
    <div x-data="{ 
            isModalOpen: false, 
            isDeleteModalOpen: $wire.entangle('showDeleteModal'),  <!-- HAPUS .defer di sini -->
        ...
        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <!-- Tombol Add Token lebih compact (seperti di sensor-manager) -->
                <button
            ...
            <!-- Display New Token - Perbaikan tampilan dan posisi tombol copy -->
                                ...
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            @else
                                                <!-- Tampilkan tombol dinonaktifkan dengan tooltip jika token sudah direvoke -->
...
<!-- Modal section - HANYA GUNAKAN SATU MODAL -->
<div 
    x-data="{ 
        open: false,
        init() {
    ...
    >
        ...
        >
            ...
            <header class="flex justify-between">
                ...
                <!-- Perbaikan untuk close button di modal -->
                <button
                    class="inline-flex items-center justify-center w-6 h-6 text-gray-400 transition-colors duration-150 rounded dark:hover:text-gray-200 hover:text-gray-700"
                    aria-label="close"
                    @click="open = false"
