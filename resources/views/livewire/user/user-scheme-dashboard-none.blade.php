...
<!-- Chart Card -->
<div class="px-4 py-3 mb-4 bg-white rounded-lg shadow-md dark:bg-gray-800 chart-container" style="height:100%">
    <!-- Integrated Header with Time Range Controls -->
    <div class="flex flex-wrap justify-between items-center chart-controls">
        <!-- Title -->
        <h3 class="text-md font-semibold text-gray-700 dark:text-gray-300"> </h3>
