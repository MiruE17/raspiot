    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                <span class="{{ request()->routeIs('admin.home') ? 'absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg' : '' }}" 
        ...
        <ul>
            <li class="relative px-6 py-3">
                <span class="{{ request()->routeIs('admin.users.*') ? 'absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg' : '' }}" 
                      aria-hidden="true"></span>
            ...
            <li class="relative px-6 py-3">
                <span class="{{ request()->routeIs('admin.sensors.*') ? 'absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg' : '' }}" 
                      aria-hidden="true"></span>
            ...
            <li class="relative px-6 py-3">
                <span class="{{ request()->routeIs('admin.tokens.*') ? 'absolute inset-y-0 left-0 w-1 bg-blue-600 rounded-tr-lg rounded-br-lg' : '' }}" 
                      aria-hidden="true"></span>
